    ...
    <main class="row d-flex">
        ...
        <div class="col-sm-12 col-md-12 col-lg-8 p-4">
            <div class="d-flex">
                ...
                <button type="button" class="btn btn-link d-flex gap-1 align-items-center ms-auto"><img src="assets/img/logout.png" alt="icon-logout" style="width: 25px; height: 25px;">Logout</button>
            </div>
            <hr>
